...
const CSS = `
  ...
  .gd-node { font-size: 0.85rem; color: var(--text-muted); margin-bottom: 1.5rem; padding: 0.5rem 0.75rem; background: rgba(255,105,180,0.06); border: 1px solid rgba(255,105,180,0.15); border-radius: var(--radius-sm); display: inline-block; }
  ...
  .gd-copy-instruction { font-size: 0.95rem; color: #86efac; margin-bottom: 1rem; font-weight: 600; }
  ...
  .gd-tech-warning { margin: 2rem 0 2.5rem; padding: 1rem 1.25rem; background: rgba(255,255,255,0.03); border: 1px dashed rgba(255,255,255,0.12); border-radius: var(--radius-sm); color: var(--text-dim); font-size: 0.9rem; line-height: 1.6; text-align: center; }
  .gd-section { margin-bottom: 2.5rem; }
  .gd-section h2 { font-size: 1.3rem; font-weight: 700; color: var(--text-bright); margin-bottom: 0.75rem; padding-bottom: 0.4rem; border-bottom: 1px solid rgba(255,255,255,0.06); }
  .gd-section p { margin-bottom: 1rem; color: var(--text); font-size: 0.95rem; white-space: pre-line; }
  .gd-code { background: rgba(0,0,0,0.4); border: 1px solid rgba(255,255,255,0.08); border-radius: var(--radius-sm); padding: 1rem 1.25rem; overflow-x: auto; font-family: 'SF Mono', 'Fira Code', 'Cascadia Code', monospace; font-size: 0.82rem; line-height: 1.6; color: #c4c4d4; white-space: pre; margin-top: 0.75rem; }
  .gd-index h1 { font-size: 2rem; font-weight: 800; color: var(--text-bright); margin-bottom: 1.5rem; line-height: 1.2; }
  .gd-card { display: block; padding: 1.25rem 1.5rem; margin-bottom: 1rem; background: var(--card-bg); border: 1px solid rgba(255,255,255,0.06); border-radius: var(--radius); text-decoration: none; color: var(--text); transition: all 0.2s; cursor: pointer; }
  .gd-card:hover { background: var(--card-bg-hover); border-color: rgba(255,105,180,0.2); transform: translateY(-1px); }
