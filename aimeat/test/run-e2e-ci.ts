 ...
 * @version-history
 *   v1.26.0 -- 2026-08-31 -- Add e2e-ai-jobs.ts: background model calls with a handle. It owns its
 *            server, because every refusal it measures is a boot-time number, and it follows the
 *            runner's backend so what it proves it proves on both.
