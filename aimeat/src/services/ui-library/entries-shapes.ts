...
export const SHAPE_ENTRIES: UiEntrySource[] = [
    ...
    shape('action', 'Action', ['poster-action', 'poster-tab'], '<a class="poster-action" href="…">…</a>',
        'An ink-underlined action in capitals; the same cut is the unselected tab.', 'A secondary action or a door in a masthead, or a tab.',
