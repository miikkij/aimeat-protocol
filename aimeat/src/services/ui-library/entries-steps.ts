...
export const STEP_ENTRIES: UiEntryWritten[] = [
    ...
    },
    {
        ...
        useFor: ['The return half of a prompt-driven step. A failed send keeps the text in the box.'],
        variants: [],
    ...
    },
    {
        ...
        useFor: ['A short name or value a person types in a step.'],
        variants: [],
    ...
    },
    {
        ...
        useFor: ['A value a person chose earlier and may change.'],
        variants: [],
    ...
    },
    {
        ...
        useFor: ['A step that can be done in more than one way, where the person picks the way first.'],
    ...
    },
    {
        ...
        useFor: ['Something the person does outside this page, where the order matters.'],
        variants: [],
    ...
    },
    {
        ...
        useFor: ['The page waits for something the person does elsewhere, and updates on its own.'],
        variants: [],
    ...
    },
    {
        ...
        useFor: ['The front page (portal.welcome-door block). It reads its own prompt from the node.'],
        variants: [],
        example: {},
    },
];
