...
const i18n: Record<string, Record<string, string>> = {
  en: {
    ...
    verificationHeading: 'Sahkopostivahvistus',
    verificationBody: 'Kaytta seuraavaa koodia sahkopostiosoitteesi vahvistamiseen:',
    verificationExpiry: 'Koodi vanhenee 15 minuutissa.',
    verificationIgnore: 'Jos et pyytanyt tata, voit ohittaa taman viestin.',
    ...
    magicLinkIgnore: 'Jos et pyytanyt tata, voit ohittaa taman viestin.',
    magicLinkFallback: 'Tai kopioi ja liita tama URL selaimeesi:',
    notificationHeading: 'AIMEAT-ilmoitus',
    matchSubject: 'Uusia ehdotuksia AIMEAT:ssa',
    matchHeading: 'Ehdotukset',
    matchBody: 'Loysimme sinulle mielenkiintoisia osumia:',
    matchSharedInterests: 'Yhteiset kiinnostukset:',
    matchDistance: 'Etaisyys:',
    matchViewProfile: 'Nayta profiili',
    footer: 'Lahetetty AIMEAT-protokollan kautta',
