/**
 * @file foundry-testing.ts
 * @description Test execution engine for the foundry pipeline. AI generates all test code
 ...
 * @version-history
 *   v1.0.0 — 2026-03-26 — Copied from generator-testing.ts (v2.1.0) and renamed to foundry
 */
 ...
 * GET /v1/foundry/test-page/:projectId/:componentId that includes auth,
