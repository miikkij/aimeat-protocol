/**
 * @file shared-fragments.ts
 * @description Shared preamble fragments injected into all generator prompts (context, disclaimer, sandbox, namespace, HTML-entity, extension-consumption rules).
...
export const SHARED_FRAGMENT_SEEDS: PromptSeedEntry[] = [
  // ═══════════════════════════════════════════════════════════════════
