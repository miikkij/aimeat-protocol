...
export const CONFIG_FIELDS: ConfigFieldDef[] = [
  ...
  { key: 'frontPage', dotPath: 'site.front_page', envVar: 'AIMEAT_FRONT_PAGE', type: 'string', validate: v => v === 'classic' || v === 'demo', immutable: false, description: 'Which front page the root serves to browsers: "classic" (the SPA landing) or "demo" (the static showroom, public/front-demo.html)' },
