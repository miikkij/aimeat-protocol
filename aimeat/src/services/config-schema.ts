...
export const CONFIG_FIELDS: ConfigFieldDef[] = [
  ...
  { key: 'storageProvider', dotPath: 'storage.type', envVar: 'AIMEAT_STORAGE', type: 'string', validate: v => ['mongodb', 'sqlite', 'memory', 'postgresql', 'postgres', 'postgres-kysely'].includes(v as string), immutable: true, description: 'Storage backend type' },
