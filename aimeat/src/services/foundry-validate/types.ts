/**
 * @file src/services/foundry-validate/types.ts
 * @description Shared type/interface declarations for the foundry component validators. Extracted from src/services/foundry-validate.ts to satisfy max-file-lines.
 * @version-history
