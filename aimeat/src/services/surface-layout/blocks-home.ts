 ...
 *
 *   NOTHING HERE IS FIXED CHROME. The nameplate, the settings door and the trust line are blocks
 *   like the rest, because the operator was given the whole page. The default layout carries all
 *   three, and the trust line carries this node's AI-labelling and data-ownership statement, so an
 *   operator removing it is removing that — their call, made on purpose, not by accident. Nobody is
 *   locked out either way: the SPA header's role-gated links are not configurable and are always
 *   there.
 *
 ...
 * @version-history
 *   v1.0.0 — 2026-08-26 — Initial: the twelve blocks of today's finished home, the onboarding step
...
export const HOME_BLOCKS: readonly SurfaceBlockDef[] = [
    ...
    {
        id: 'home.settings-door',
        surfaces: ['home', 'home-onboarding'],
        presence: { kind: 'always' },
        localeStem: 'home.settings',
        liveDomains: [],
        props: {},
        maxPerSurface: 1,
        summary: 'The way into their own settings from this page.',
    },
    {
        id: 'home.steps',
