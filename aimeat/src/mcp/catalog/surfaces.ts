...
export const MCP_SURFACES: Record<SurfaceRole, string[]> = {
    appdev: [
        ...
        'aimeat_workspace_create', 'aimeat_workspace_list', 'aimeat_workspace_read', 'aimeat_workspace_write_draft', 'aimeat_workspace_publish', 'aimeat_workspace_add_document', 'aimeat_workspace_object_delete', 'aimeat_workspace_update', 'aimeat_workspace_access', 'aimeat_workspace_transfer',
        'aimeat_handbook_get',
    ],
    agent: [
