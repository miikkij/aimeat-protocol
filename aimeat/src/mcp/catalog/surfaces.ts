...
export const MCP_SURFACES: Record<SurfaceRole, string[]> = {
    appdev: [
        ...
        'aimeat_workspace_create', 'aimeat_workspace_list', 'aimeat_workspace_read', 'aimeat_workspace_write_draft', 'aimeat_workspace_publish', 'aimeat_workspace_add_document', 'aimeat_workspace_delete', 'aimeat_workspace_update', 'aimeat_workspace_request_access', 'aimeat_workspace_list_requests', 'aimeat_workspace_approve_access', 'aimeat_workspace_export', 'aimeat_workspace_import',
        'aimeat_handbook_get',
    ],
    agent: [
