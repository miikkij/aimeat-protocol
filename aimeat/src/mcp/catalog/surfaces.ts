...
export const MCP_SURFACES: Record<SurfaceRole, string[]> = {
    appdev: [
        ...
        'aimeat_organism_list', 'aimeat_organism_get', 'aimeat_organism_members', 'aimeat_organism_join', 'aimeat_organism_leave', 'aimeat_organism_create', 'aimeat_organism_export', 'aimeat_organism_import',
        'aimeat_workspace_create', 'aimeat_workspace_list', 'aimeat_workspace_read', 'aimeat_workspace_write_draft', 'aimeat_workspace_publish', 'aimeat_workspace_add_document', 'aimeat_workspace_object_delete', 'aimeat_workspace_update', 'aimeat_workspace_access', 'aimeat_workspace_export', 'aimeat_workspace_import',
        'aimeat_handbook_get',
    ],
    agent: [
