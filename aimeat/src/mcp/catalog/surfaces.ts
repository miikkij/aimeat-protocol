...
export const MCP_SURFACES: Record<SurfaceRole, string[]> = {
    appdev: [
        ...
        'aimeat_organism_list', 'aimeat_organism_get', 'aimeat_organism_members', 'aimeat_organism_join', 'aimeat_organism_leave', 'aimeat_organism_create',
        'aimeat_workspace_create', 'aimeat_workspace_list', 'aimeat_workspace_read', 'aimeat_workspace_write_draft', 'aimeat_workspace_publish', 'aimeat_workspace_add_document', 'aimeat_workspace_delete', 'aimeat_workspace_request_access', 'aimeat_workspace_list_requests', 'aimeat_workspace_approve_access',
        'aimeat_handbook_get',
    ],
    agent: [
