 ...
 *     publish/add_document/delete) to appdev/agent/service; also add the organism tools to appdev.
 */
...
export const MCP_SURFACES: Record<SurfaceRole, string[]> = {
    appdev: [
        ...
        'aimeat_workspace_list', 'aimeat_workspace_read', 'aimeat_workspace_write_draft', 'aimeat_workspace_publish', 'aimeat_workspace_add_document', 'aimeat_workspace_delete',
        'aimeat_handbook_get',
    ],
    agent: [
