...
export function siteRouter(config: AimeatConfig, storage: Storage): Router {
    const router = Router();
    ...
    router.post('/v1/site/template', requireAuth(), requireRole('operator'), async (req, res) => {
    ...
    router.delete('/v1/site/template', requireAuth(), requireRole('operator'), async (req, res) => {
    ...
    router.post('/v1/site/import', requireAuth(), requireRole('operator'), async (req, res) => {
        const body = req.body ?? {};
