...
export const CONFIG_DEFAULTS: Record<string, string> = {
  ...
  AIMEAT_AI_SUPERVISORY_NAME: '',
  AIMEAT_AI_SUPERVISORY_URL: '',
  AIMEAT_AI_COP_SECTIONS: '',
  AIMEAT_AI_COP_SIGNED_ON: '',
