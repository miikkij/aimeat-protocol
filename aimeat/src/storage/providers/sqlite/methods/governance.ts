...
export const governanceMethods = {
  // Consent lives in ./consent.ts — same object, extracted for max-file-lines. Spread rather than
  // re-exported so every method still lands on the same prototype the interface expects.
  ...consentMethods,
