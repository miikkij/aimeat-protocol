...
(() => {
  ...
  var defaults = {
    ...
    turn: { silenceMs: 700, minSpeechMs: 250, maxSpeechMs: 3e4, threshold: 0.025, preRollMs: 200, bargeIn: false, interruptMs: 200, resumeQuietMs: 300 },
  ...
  function configure(options = {}) {
    ...
    for (const key of ["silenceMs", "minSpeechMs", "maxSpeechMs", "preRollMs", "interruptMs", "resumeQuietMs"]) range(result.turn[key], 0, 12e4, "turn." + key);
