...
export const PRESET_IDS = ['waves', 'aurora', 'dust', 'grid', 'static', 'ink'];
/** The alpha a preset ships at when a look or an app names none (the registry's defaultAlpha). */
export const BASE_ALPHA = { waves: 0.22, aurora: 0.3, dust: 0.6, grid: 0.5, static: 0.25, ink: 0.35 };
/** The strongest pigment a preset composites anywhere at alpha 1 (the registry's peak). */
export const PEAK = { waves: 0.35, aurora: 0.26, dust: 0.5, grid: 0.6, static: 0.3, ink: 0.22 };
/** Frames per second each loop is gated to; 0 for the compositor preset. */
export const FPS = { waves: 30, aurora: 0, dust: 30, grid: 30, static: 12, ink: 24 };
...
export const RENDERERS = { waves, dust, grid, static: staticNoise, ink };
